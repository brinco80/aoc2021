defmodule Q12 do
  ...
  def path_from(x, graph, path) do
    ...
    ns = get_neighbors(path, graph) #|> IO.inspect()
  ...
  def path_from2(x, graph, path) do
    ...
    #path |> IO.inspect()
    #IO.puts("Neighbors of #{x} ")
    ns = get_neighbors2(path, graph) #|> IO.inspect()
